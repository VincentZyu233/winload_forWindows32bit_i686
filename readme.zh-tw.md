...
> wtp
> ```
> 💡 Scoop 僅提供 **x86_64** 和 **ARM64** 的 **MSVC + Npcap** 構建。如需其他變體（MinGW、無 Npcap）或舊版 Windows（7/Vista/8），請從 [GitHub Releases](https://github.com/VincentZyuApps/winload/releases) 手動下載。
