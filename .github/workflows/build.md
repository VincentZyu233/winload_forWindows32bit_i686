...
|----------|:---:|--------|-------|
| Windows | x64 (npcap) | `x86_64-pc-windows-msvc` | With Npcap capture support, built natively with MSVC, Windows 7+ |
| Windows | x64 (basic) | `x86_64-pc-windows-msvc` | Standalone without Npcap (`--no-default-features`), MSVC, Windows 7+ |
| Windows | x64 (XP) | `x86_64-pc-windows-gnu` | MinGW-w64 for legacy Windows XP/Vista/7+ |
| Windows | ARM64 (npcap) | `aarch64-pc-windows-msvc` | With Npcap capture, cross-compiled with MSVC, Windows 7+ (Snapdragon X/ Surface Pro X) |
| Windows | ARM64 (basic) | `aarch64-pc-windows-msvc` | Standalone without Npcap (`--no-default-features`), MSVC, Windows 7+ |
| Windows | x86 (i686 basic) | `i686-pc-windows-msvc` | 32-bit standalone MSVC, no Npcap, Windows 7+ |
| Windows | x86 (i686 XP) | `i686-pc-windows-gnu` | 32-bit MinGW-w64 for legacy Windows XP/Vista/7+ |
