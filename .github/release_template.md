...
> x86 (32-bit) 仅提供 Windows exe 和 Linux 二进制，不包含 DEB/RPM 包，也不推送到 npm / Scoop / AUR 源。
...
| **x86 (32-bit)** | [![exe](https://img.shields.io/badge/exe-x86-0078D6.svg?logo=windows)](__BASE_URL__/winload-windows-i686-__VERSION__.exe) | [![binary](https://img.shields.io/badge/binary-i686-E95420.svg?logo=linux)](__BASE_URL__/winload-linux-i686-__VERSION__) | — | — |
